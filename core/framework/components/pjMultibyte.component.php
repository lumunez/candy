 ...
 */
	public static function stripos($haystack, $needle, $offset = 0) {
		if (pjMultibyte::checkMultibyte($haystack)) {
			$haystack = pjMultibyte::strtoupper($haystack);
			$needle = pjMultibyte::strtoupper($needle);
			return pjMultibyte::strpos($haystack, $needle, $offset);
		}
 ...
 */
	public static function strlen($string) {
		if (pjMultibyte::checkMultibyte($string)) {
			$string = pjMultibyte::utf8($string);
			return count($string);
		}
 ...
 */
	public static function strtolower($string) {
		$utf8Map = pjMultibyte::utf8($string);
		...
		return pjMultibyte::ascii($lowerCase);
	}
 ...
 */
	public static function strtoupper($string) {
		...
		return pjMultibyte::ascii($upperCase);
	}
 ...
 */
	public static function substr($string, $start, $length = null) {
		...
		if ($length === null || count($string) < $length) {
			return pjMultibyte::ascii($string);
		}
		...
		return pjMultibyte::ascii($value);
	}
