...
foreach ($tpl['arr'] as $v)
{
	...
	<div class="property-listing">
		<div class="property-body-pic"><a href="<?php echo $url; ?>"><img src="<?php echo PJ_INSTALL_URL . (!empty($v['pic']) ? $v['pic'] : PJ_IMG_PATH . 'no-image2.png'); ?>" alt="<?php echo $property_title; ?>" /></a></div>
		<div class="property-listing-right">
			<div class="property-body-details">
				...
				<div class="property-item-price">
					<?php __('front_price_from'); ?>
					<span><?php echo !empty($v['price']) ? pjUtil::formatCurrencySign(number_format($v['price'], 0), $tpl['option_arr']['o_currency']) : __('front_index_na', true); ?></span>
				</div>
