...
<div class="property-container">
	...
	?>
	<div class="property-state property-view-content">
		...
		<div class="vrl-float-left vrl-w45p">
			...
			<p>
				...
				<span class="property-datepicker-wrap">
					<input type="text" name="date_from" id="vrl_d_from" class="property-datepicker-input vrl-w140" readonly="readonly" value="<?php echo isset($_GET['date_from']) ? htmlspecialchars($_GET['date_from']) : NULL; ?>" />
			...
			<p>
				...
				<span class="property-datepicker-wrap">
					<input type="text" name="date_to" id="vrl_d_to" class="property-datepicker-input vrl-w140" readonly="readonly" value="<?php echo isset($_GET['date_to']) ? htmlspecialchars($_GET['date_to']) : NULL; ?>" />
