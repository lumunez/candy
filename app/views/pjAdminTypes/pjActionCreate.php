...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoTypesCreateTitle', true), __('infoTypesCreateBody', true));
	?>
	<div class="multilang"></div>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTypes&amp;action=pjActionCreate" method="post" id="frmCreateType" class="form pj-form">
