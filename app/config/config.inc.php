...
if (!defined("PJ_DB")) define("PJ_DB", "db517455536");
if (!defined("PJ_PREFIX")) define("PJ_PREFIX", "");
if (!defined("PJ_INSTALL_FOLDER")) define("PJ_INSTALL_FOLDER", "/candy/");
if (!defined("PJ_INSTALL_PATH")) define("PJ_INSTALL_PATH", "C:/xampp/htdocs/candy/");
if (!defined("PJ_INSTALL_URL")) define("PJ_INSTALL_URL", "http://localhost/candy/");
if (!defined("PJ_SALT")) define("PJ_SALT", "N9HQF5XM");
