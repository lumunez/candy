...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "82");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.0.1");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "vacationrentals_");
...
if (!defined("PJ_GALLERY_SMALL")) define("PJ_GALLERY_SMALL", "90,68");
if (!defined("PJ_GALLERY_MEDIUM")) define("PJ_GALLERY_MEDIUM", "215,161");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjGallery', 'pjBackup', 'pjLog', 'pjInstaller', 'pjPaypal', 'pjAuthorize', 'pjOneAdmin', 'pjSms');
?>