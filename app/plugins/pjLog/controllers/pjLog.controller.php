...
require_once dirname(__FILE__) . '/pjLogAppController.controller.php';
class pjLog extends pjLogAppController
{
	public function pjActionConfig()
	{
		...
		if ($this->isAdmin())
		{
			pjObject::import('Model', 'pjLog:pjLogConfig');
	...
	public function pjActionLogger()
	{
    	...
    	{
			pjObject::import('Model', array('pjLog:pjLog', 'pjLog:pjLogConfig'));
