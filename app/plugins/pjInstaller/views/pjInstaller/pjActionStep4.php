					...
					<form action="index.php?controller=pjInstaller&amp;action=pjActionStep5&amp;install=1" method="post" id="frmStep4" class="i-form">
						...
						<div>
							...
							<div class="float_left">
								<input type="button" tabindex="4" value="&laquo; Back" class="pj-button" onclick="window.location='index.php?controller=pjInstaller&amp;action=pjActionStep3'" />
								<input type="submit" tabindex="3" value="Continue &raquo;" class="pj-button" />
							</div>
							<div class="float_right t10">Need help? <a href="http://www.phpjabbers.com/contact.php" target="_blank">Contact us</a></div>
							<br class="clear_both" />
						</div>
					</form>
				</td>
	...
	switch ($tpl['status'])
	{
		case 101:
			...
			<p class="form_install">
				Key not verified
				<br /><br />
				<input type="button" value="Back" onclick="window.location='index.php?controller=pjInstaller&amp;action=pjActionStep3'" />
			</p>
			<?php
			break;
		case 102:
